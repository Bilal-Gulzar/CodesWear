...
setAddress(evt.target.value);
 ...
 const handleSub = async(evt)=>{
   evt.preventDefault();
   setIsLoading(true)
if(phone.length != 11) return toast.error("Please Enter correct number"), setIsLoading(false); 
if(!(pin.length == 5)) return toast.error("Your Pincode must contain 5 numbers "),setIsLoading(false); 
if(password.length < 8) return toast.error("Your Password must contain at least 8 characters "),setIsLoading(false);
    ...
    <div className="lg:pt-[21.3%]  xl:pt-[12%] pb-14 dark:bg-[#1f2937]">
      ...
      <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          <form onSubmit={handleSub} className="space-y-[0px]" method="POST">
            <div>
              <div className="mt-2">
                <input
                  id="name"
