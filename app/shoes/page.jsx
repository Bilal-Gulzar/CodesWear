                ...
                <ul className="grid grid-cols-7 h-[40px]">
                  ...
                  <li className="border-gray-300  dark:hover:bg-gray-800 border-[1px] border-l-0 hover:bg-gray-100 ">
                    <Link href={`?pageno=${prePage}`}>
                      <button
                        ...
                        className="w-full h-full disabled:cursor-not-allowed flex justify-center items-center "
                      >
                  ...
                  <li className="border-gray-300 relative text-md  text-pink-500 font-semibold font-sans  border-l-0  dark:hover:bg-pink-500 border-[1px]  hover:bg-pink-300 hover:text-pink-700 bg-pink-200">
                    <Link href={`?pageno=${currentPageno}`}>
                      <button
                        disabled={true}
                        className=" cursor-not-allowed  absolute w-full h-full flex justify-center items-center outline-none "
                      >
                        {currentPageno}
                      </button>
                    </Link>
                  </li>
                  <li className="border-gray-300  dark:hover:bg-gray-800 text-md font-sans border-l-0  border-[1px] hover:bg-gray-100 relative ">
                    <Link href={`?pageno=${front}`}>
                      <button
                        disabled={front > totalPages ? true : false}
                        className="w-full h-full flex justify-center items-center dark:text-gray-100 absolute outline-none disabled:cursor-not-allowed  "
                      >
                        {front}
                      </button>
                    </Link>
