          ...
          <div className="sm:ml-[8%] ml-4 pt-8 lg:pt-64 xl:pt-32">
            ...
            <div className="mt-7">
              ...
              <p className=" font-sans pt-4 pr-7 sm:pr-20 2xl:pr-64 xl:pr-44 break-words leading-relaxed dark:text-gray-100">
                Welcome to Codeswear, a brand owned by CWH Solutions! These
                terms and conditions ("Terms") govern your access to and use of
                our ecommerce website (the "Website"). By using the Website, you
            ...
            <div className="mt-7">
              ...
              <p className=" font-sans pt-4 pr-7 sm:pr-20 2xl:pr-64 xl:pr-44 break-words leading-relaxed dark:text-gray-100">
                ...
                prohibited from using, copying, or distributing any content from
            ...
            <div className="mt-7">
              ...
              <p className=" font-sans pt-4 pr-7 sm:pr-20 2xl:pr-64 xl:pr-44 break-words leading-relaxed dark:text-gray-100">
                ...
                information about our products on the Website. However, we do
                not guarantee the accuracy, completeness, or reliability of any
                product information. You acknowledge that the actual colors,
                dimensions, and specifications of products may differ from the
                images and descriptions displayed on the Website.
              </p>
            </div>
            <div className="mt-7">
              <h3 className="font-sans font-semibold text-black text-2xl dark:text-gray-100">
              ...
              <p className=" font-sans pt-4 pr-7 sm:pr-20 2xl:pr-64 xl:pr-44 break-words leading-relaxed dark:text-gray-100">
                ...
                at any time for any reason. In the event of a pricing error on
                the Website, we may refuse or cancel any such orders, even if
                the order has been confirmed and payment has been made. We will
                notify you of any changes or cancellations related to your
                order.
              </p>
            </div>
            <div className="mt-7">
              ...
              <p className=" font-sans pt-4 pr-7 sm:pr-20 2xl:pr-64 xl:pr-44 break-words leading-relaxed dark:text-gray-100">
                To the extent permitted by applicable law, Codeswear, a brand
                owned by CWH Solutions shall not be liable for any direct,
                indirect, incidental, consequential, or exemplary damages,
                including but not limited to loss of profits, data, or business
                opportunities arising out of your use of the Website or any
