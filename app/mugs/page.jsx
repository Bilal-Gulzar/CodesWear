...
export default async  function Mugs({searchParams}) {
  ...
  const mugs = Allproducts.tshirts;
                  ...
                  <div className="dark:bg-[#374151] relative rounded-b-lg -left-4 h-[43%] w-[114.6%]">
                    <div className="relative dark:top-7  top-5 left-5">
                      <h3 className="text-gray-500 dark:text-gray-400 text-xs tracking-widest font-sans font-medium title-font mb-1">
                        {mugs[v].category.toString().toUpperCase()}
                      </h3>
                      <h2 className="text-gray-900 dark:text-gray-100 title-font font-sans text-lg font-medium">
                        {mugs[v].tittle.length > 21 ? (
                          <span>{mugs[v].tittle.substr(0, 21)}...</span>
                        ) : (
                          mugs[v].tittle
                        )}
                      </h2>
                    ...
                    <div className="relative top-8 dark:top-10 left-5 flex space-x-[0.7px]">
                      {mugs[v].color.map((x, i) => (
                        <div
                          key={i}
                          style={{
                            background: `${
                    ...
                    <div className="mt-12 dark:pt-[15px] ml-5 mb-2 ">
                      {mugs[v].size.map((size,i) => (
                        <span key={i} className="text-md border-2 dark:text-gray-100 py-1 font-sans text-black px-2 mx-[2px]">
                          {size}
                        </span>
                      ))}
                    </div>
