                ...
                <ul className="grid grid-cols-7 h-[40px]">
                  ...
                  <li className="border-gray-300 relative  dark:hover:bg-gray-800 text-md font-sans border-l-0  border-[1px] hover:bg-gray-100">
                    <Link href={`?pageno=${back}`}>
                      <button
                        disabled={back === 0 ? true : false}
                        className=" w-full h-full flex justify-center items-center absolute dark:text-gray-100 outline-none disabled:cursor-not-allowed "
                      >
                        {back}
                      </button>
                    </Link>
                  ...
                  <li className="border-gray-300 relative  text-md  text-pink-500 font-semibold font-sans  border-l-0  dark:hover:bg-pink-500 border-[1px] hover:bg-pink-300 hover:text-pink-700 bg-pink-200">
                    <Link href={`?pageno=${currentPageno}`}>
                      <button
                        disabled={true}
                        className=" cursor-not-allowed w-full h-full flex justify-center items-center absolute outline-none "
                      >
                        {currentPageno}
                      </button>
                    </Link>
                  ...
                  <li className="border-gray-300 relative dark:hover:bg-gray-800 text-md font-sans border-l-0  border-[1px]  hover:bg-gray-100">
                    <Link href={`?pageno=${front}`}>
                      <button
                        ...
                        className="w-full h-full absoluteflex justify-center items-center dark:text-gray-100 outline-none disabled:cursor-not-allowed  "
                      >
                        {front}
                      </button>
                    </Link>
