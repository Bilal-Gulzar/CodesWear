  ...
  return (
    <>
      {isLoading ? (
        ...
        <div className="pt-20 lg:pt-72 xl:pt-40 pb-1 2xl:max-w-[1600px] 2xl:mx-auto dark:bg-[#1f2937]">
          <div>
            <img
              src="/codes.jpg"
              width={150}
            ...
            <div className="flex md:flex-row flex-col ">
              <div className="  w-[80vw] mx-auto md:w-[60%] text-start md:text-start md:ml-[7%] md:order-1 order-2 ">
                <p className=" font-sans pt-5 pr-4 leading-relaxed dark:text-gray-100">
                  Codeswear.com is revolutionizing the way India shops for
                  unique, geeky apparel. From our one-of-a-kind hoodie designs
                  to our wide selection of stickers, mugs and other accessories,
                  we have everything you need to express your individuality and
                  ...
                  <br /> <br />
                  But what sets Codeswear apart from the competition? The answer
                  is simple: our unique designs and commitment to providing the
                  highest quality products. We understand the importance of
                  style and durability, which is why we put so much effort into
                  creating unique designs and using only the best materials.
                  Don't settle for mediocre clothing and accessories - choose
                  Codeswear and make a statement with your wardrobe.
                  <br /> <br />
                  At Codeswear, we strive to be more than just an online store -
                  we want to be a community where like-minded individuals can
                  come together and express themselves through fashion. Whether
                  you're a gamer, a programmer, or simply someone who loves all
                  things geeky, we have something for you. Our collection is
                  curated with the latest trends and fan favorites in mind,
                  ensuring that you'll always find something new and exciting.
                  <br /> <br />
                  We also understand the importance of affordability and
                  convenience. That's why we offer competitive prices and fast
                  shipping, so you can get your hands on your new geeky apparel
                  as soon as possible. Plus, with our easy-to-use website and
                  secure checkout process, shopping with us is a breeze. So why
                  wait? Visit Codeswear.com today and discover the latest in
                  geeky fashion. With our unique designs and high-quality
                  products, we're sure you'll find something you'll love. Join
                  our community and express your individuality through fashion.
                  <br /> <br />
                  So why wait? Visit Codeswear.com today and discover the latest
                  in geeky fashion. With our unique designs and high-quality
                  products, we're sure you'll find something you'll love. Join
                  our community and express your individuality through fashion.
                </p>
              </div>
            ...
            <div className="flex md:justify-center md:flex-row flex-col md:gap-8 mb-32">
              ...
              <div className="bg-gray-100 dark:bg-[#374151] w-[90vw] mx-auto md:mx-0 md:w-[43%] rounded-lg h-auto mt-11">
                <p className="dark:text-gray-100 font-sans break-all px-12 py-9">
                  <FaQuoteRight className="pb-4 size-9 dark:text-[#9ca3af]" />I
                  recently purchased a hoodie and t-shirt from this online
