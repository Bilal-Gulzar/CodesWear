          ...
          <div className="sm:ml-[8%] ml-4 pt-8 lg:pt-64 xl:pt-32">
            ...
            <div className="mt-8">
              ...
              <p className=" font-sans pt-4 pr-7 sm:pr-20 2xl:pr-64 xl:pr-44 break-words leading-relaxed dark:text-gray-100">
                This Privacy Policy describes how CWH Solutions ("Codeswear,"
                "we," "us," or "our") collects, uses, and discloses your
                personal information when you use our ecommerce website (the
                "Website"). By accessing or using the Website, you consent to
            ...
            <div className="mt-5">
              ...
              <ul className="mt-5 list-disc ml-7 sm:ml-9">
                ...
                <li className=" font-sans pr-5 leading-2 dark:text-gray-100">
                  In response to legal process, such as a subpoena or court
                  order
                </li>
                <li className=" font-sans pr-5 leading-2 dark:text-gray-100">
            ...
            <div className="mt-7">
              ...
              <p className=" font-sans pt-4 pr-7 sm:pr-20 2xl:pr-64 xl:pr-44 break-words leading-relaxed dark:text-gray-100">
                ...
                including the right to access, update, and delete your
                information. You may also opt-out of receiving marketing
                communications from us. Please contact us using the information
                provided below to exercise your rights or for any
            ...
            <div className="mt-7">
              ...
              <p className=" font-sans pt-4 pr-7 sm:pr-20 2xl:pr-64 xl:pr-44 break-words leading-relaxed dark:text-gray-100">
                ...
                effective as of the updated date. We encourage you to review
